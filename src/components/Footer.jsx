    ...
    <footer className="footer--container">
      ...
      <div className="footer--link--container">
        ...
        <div className="footer--contact--info">
          <ul>
            <li>
              <span className="contact-info--item">Email: kongsehchong2002@gmail.com</span>
            </li>
            <li>
              <span className="contact-info--item">Phone: 018-262827</span>
            </li>
            <li>
              <span className="contact-info--item">Address: 123 Street, City, Country</span>
            </li>
          </ul>
        </div>
      </div>
